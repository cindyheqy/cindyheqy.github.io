...
Though I know that this is also a little bit vague. What is better is that I have a more specific field that I'd love to dedicate to. But I do not want to lie to the admissions. I do not want to tell lies in my essays, just to make myself admitted to the program (not mention that there is no gurantee for me to be admitted to the program)
对，其实cs就算拒绝我，也说明我可能现阶段并不适合学cs，也是他们对我的一种能力界定。这没有什么可怕的。就算不读cs，我也可以继续读完mpp，走我想走的方向，或者我有了新的更加明确或者合适的兴趣。但是这不可以是我的退路。我要转就要不给自己留任何退路。
